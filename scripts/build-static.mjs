...
const files = ['index.html', 'styles.css', 'ledger.css', 'runtime-storage.js', 'overview-map.js', 'route-ui.js', 'app.js', 'amap-links.js', 'ticket-pdf-preview.js', 'ledger.js', 'site-navigation.js', 'trip-data.json', '_headers'];
